...
export default class ListareSandwichuri extends Component {
    ...
    componentDidMount(){
        api.get('/getSandwichuri')
        .then(res => {
            if(!res.data.success)
                console.log(res)
            else{
                this.setState({sandwichuri: res.data.sandwichuri, loading: false})
                        ...
                        {this.state.loading ? null : this.state.sandwichuri.products.map((sandwich, key)=>{
                            ...
                            <View key={key} style={styles.produsContainer}>
                                ...
                                <View style={styles.produsDimensiuni}>
                                    ...
                                    onPress={() => this.props.navigation.navigate('DetaliuSandwich', {sandwich: sandwich})}
                                    >
